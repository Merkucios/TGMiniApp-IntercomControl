export const InputTelephoneWidget = () => {
  return (
    <form>
      <div className="flex flex-col gap-4">
        ...
        <button
          type="button"
          className="md:text-md text-md me-2 h-14 rounded-md bg-white px-5 py-2.5 text-center text-sky-500 hover:bg-gradient-to-br hover:text-sky-700 focus:outline-none focus:ring-4 focus:ring-blue-300 lg:text-lg xl:text-xl dark:focus:ring-blue-800"
        >
          Не пришла СМС
        </button>
      </div>
